...
from preprocessing import CustomTokenizerExample
...
def get_tweets(api, count): 
        ...
        try: 
            ...
            fetched_tweets = tweepy.Cursor(api.search_tweets, q=query, lang ='en', geocode = '14.589119422692292,121.0263763730469,17097.55km', tweet_mode='extended').items(count)
